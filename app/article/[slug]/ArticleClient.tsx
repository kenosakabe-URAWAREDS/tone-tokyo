      ...
      <div style={{ background: C.offWhite, minHeight: "100vh" }}>
        ...
        <div ref={heroRef}>
          ...
          <div style={{ position: "relative", width: "100%", height: "80vh", minHeight: 420, maxHeight: 900, overflow: "hidden" }}>
            <img src={heroImage} alt={article.title} style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 60%", display: "block" }} />
        ...
        <div style={{ padding: "20px 16px 40px", maxWidth: 800, margin: "0 auto" }}>
          {article.gallery.map((url: string, i: number) => (
            <img key={i} src={url} alt={article.title + " " + (i + 2)} style={{
              width: "100%", maxWidth: 320, borderRadius: 4, marginBottom: 16, display: "block", margin: "0 auto 16px",
            }} />
          ))}
        </div>
      )}
